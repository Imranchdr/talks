 ...
 * Available under MIT license <https://lodash.com/license>
 */
var getNative = require$$2,
    isArguments = require$$1,
    isArray = require$$0$1;
...
var shallowEqual = (index && typeof index === 'object' && 'default' in index ? index['default'] : index);
...
var AnimatedSpriteSheet = function (_Component) {
  ...
  function AnimatedSpriteSheet(props) {
    ...
    var maxFramesWidth = Math.floor((_this.props.bounds.width - _this.props.bounds.x) / _this.props.frame.width);
    var maxFramesHeight = Math.floor((_this.props.bounds.height - _this.props.bounds.y) / _this.props.frame.height);
